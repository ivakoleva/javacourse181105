...
public class RunnerDay2 {
    ...
    //private static final Map<Integer, Person> personBatch = new HashMap<>();
    ...
    public static void main(String[] args) {
        ...
        //final Map<Integer, ? extends Ageable> unmodifiablePersonMap = Collections.unmodifiableMap(personBatch);
